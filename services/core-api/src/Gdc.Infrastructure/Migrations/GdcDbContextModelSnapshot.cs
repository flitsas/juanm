            ...
            modelBuilder.Entity("Gdc.Infrastructure.Persistence.Auth.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "reglas.read",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Consultar reglas, logs y contactos secretarÃ­a",
                            IsActive = true,
                            Module = "reglas",
                            RowVersion = 0u,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        ...
                        new
                        {
                            ...
                            Code = "reglas.write",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Gestionar reglas y contactos secretarÃ­a",
                            IsActive = true,
                            Module = "reglas",
                            RowVersion = 0u,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
            ...
            modelBuilder.Entity("Gdc.Infrastructure.Persistence.Auth.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "TenantAdmin",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "AdministraciÃ³n de usuarios y permisos del tenant",
                            IsActive = true,
            ...
            modelBuilder.Entity("Gdc.Modules.Notif.Domain.Entities.TenantCompany", b =>
                {
                    ...
                    b.ToTable("tenants", "identity");
                        ...
                        modelBuilder.Entity("Gdc.Modules.Plantillas.Domain.Entities.DerechoPeticion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ComparendoId")
                        .HasDatabaseName("ix_derechos_peticion_comparendo_id");

                    b.HasIndex("PdfTemplateId")
                        .HasDatabaseName("ix_derechos_peticion_pdf_template_id");

                    b.HasIndex("TenantId", "ComparendoId", "Estado")
                        .HasDatabaseName("ix_derechos_peticion_tenant_comparendo_estado");

                    b.ToTable("derechos_peticion", "gdc");
                });
            modelBuilder.Entity("Gdc.Modules.Plantillas.Domain.Entities.PdfTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("pdf_templates", "gdc");
                });
            modelBuilder.Entity("Gdc.Modules.Plantillas.Domain.Entities.PdfTemplateField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AcroformName")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("acroform_name");

                    b.Property<string>("ChoiceOptionsJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("choice_options_json");
                    ...
                    b.HasIndex("PdfTemplateId")
                        .HasDatabaseName("ix_pdf_template_fields_pdf_template_id");

                    b.HasIndex("PdfTemplateId", "AcroformName")
                        .IsUnique()
                        .HasDatabaseName("uq_pdf_template_fields_template_acroform")
                        .HasFilter("deleted_at IS NULL");

                    b.ToTable("pdf_template_fields", "gdc");
                });
            modelBuilder.Entity("Gdc.Modules.Plantillas.Domain.Entities.DerechoPeticion", b =>
                {
                    b.HasOne("Gdc.Modules.Plantillas.Domain.Entities.PdfTemplate", "PdfTemplate")
                        .WithMany("DerechosPeticion")
